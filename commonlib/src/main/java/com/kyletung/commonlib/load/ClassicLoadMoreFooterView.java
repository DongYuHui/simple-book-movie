...
public class ClassicLoadMoreFooterView extends SwipeLoadMoreFooterLayout {
    ...
    public ClassicLoadMoreFooterView(Context context, AttributeSet attrs, int defStyleAttr) {
        ...
        mFooterHeight = getResources().getDimensionPixelOffset(R.dimen.load_footer_height);
    }
    ...
    public void onMove(int y, boolean isComplete, boolean automatic) {
        if (!isComplete) {
            ...
            if (-y >= mFooterHeight) {
                tvLoadMore.setText(getResources().getString(R.string.load_more_release));
            } else {
                tvLoadMore.setText(getResources().getString(R.string.load_more_swipe));
            }
        }
    }

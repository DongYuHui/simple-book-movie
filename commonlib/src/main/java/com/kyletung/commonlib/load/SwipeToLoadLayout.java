...
import com.kyletung.commonlib.view.EmptyView;
...
public class SwipeToLoadLayout extends ViewGroup {
    ...
    protected void onFinishInflate() {
        ...
        if (childNum == 0) {
            ...
            mEmptyView = findViewById(R.id.swipe_empty_view);
        } else {
    ...
    public void setShowEmptyView(boolean show) {
        if (mEmptyView != null) mEmptyView.setVisibility(show ? VISIBLE : GONE);
    }
    ...
    public void setEmptyViewBackground(int color) {
        if (mEmptyView != null) mEmptyView.setBackgroundColor(color);
    }
    ...
    public void setEmptyViewText(String text) {
        if (mEmptyView != null) ((EmptyView) mEmptyView).setText(text);
    }
     ...
     * @param resource 文字资源
     */
    public void setEmptyViewText(int resource) {
        if (mEmptyView != null) ((EmptyView) mEmptyView).setText(getContext().getString(resource));
    }
    ...
    private void layoutChildren() {
        ...
        if (mTargetView != null) {
            ...
            if (mEmptyView != null)
                mEmptyView.layout(targetLeft, targetTop, targetRight, targetBottom);
        }
        ...
        if (mEmptyView != null) mEmptyView.bringToFront();
    }

...
public class NiceSpinner extends TextView {
    ...
    private void init(Context context, AttributeSet attrs) {
        ...
        int defaultPadding = resources.getDimensionPixelSize(R.dimen.base_dimen_12dp);

        setGravity(Gravity.CENTER);
//        setPadding(resources.getDimensionPixelSize(R.dimen.base_dimen_24dp), defaultPadding, defaultPadding, defaultPadding);
        setPadding(resources.getDimensionPixelSize(R.dimen.base_dimen_8dp), 0, resources.getDimensionPixelSize(R.dimen.base_dimen_8dp), 0);
        setClickable(true);
        setSingleLine();
...
//        adapter = new NiceSpinnerAdapter<>(getContext(), dataset, textColor);

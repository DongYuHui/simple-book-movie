...
import com.kyletung.doubanbookmovie.movie.MovieRecyclerAdapter;
 ...
 */
public class SearchFragmentMovie extends Fragment {
    ...
    public View onCreateView(LayoutInflater inflater, ViewGroup container,
        ...
        swipeRefreshLayout = (SwipeRefreshLayout) view.findViewById(R.id.fragment_search_movie_swipe);
    ...
    public void get() {
        if (adapter.getItemCount() < total) {
            JsonObjectRequest jsonObjectRequest = new JsonObjectRequest(Request.Method.GET, movieUrl + adapter.getItemCount(), null, new Response.Listener<JSONObject>() {
                @Override

 ...
 */
public class BookFragmentUnreaded extends Fragment {
    ...
    public View onCreateView(LayoutInflater inflater, ViewGroup container,
        ...
        View view = inflater.inflate(R.layout.fragment_book_unreaded, container, false);

        //init recycler view
        RecyclerView recyclerView = (RecyclerView) view.findViewById(R.id.fragment_book_unreaded_recycler);
        ...
        swipeRefreshLayout = (SwipeRefreshLayout) view.findViewById(R.id.fragment_book_unreaded_swipe);
                ...
                public void onResponse(JSONObject response) {
                    ...
                    try {
                        ...
                        for (int j = 0; j < array.length(); j++) {
                            if (array.getJSONObject(j).getString("status").equals("wish")) {

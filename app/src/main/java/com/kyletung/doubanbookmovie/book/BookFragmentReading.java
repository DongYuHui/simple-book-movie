 ...
 */
public class BookFragmentReading extends Fragment {
    ...
    public View onCreateView(LayoutInflater inflater, ViewGroup container,
        ...
        //init recycler view
        RecyclerView recyclerView = (RecyclerView) view.findViewById(R.id.fragment_book_reading_recycler);
        ...
        swipeRefreshLayout = (SwipeRefreshLayout) view.findViewById(R.id.fragment_book_reading_swipe);
                ...
                public void onResponse(JSONObject response) {
                    ...
                    try {
                        ...
                        for (int j = 0; j < array.length(); j++) {
                            if (array.getJSONObject(j).getString("status").equals("reading") || array.getJSONObject(j).getString("status").equals("doing")) {
